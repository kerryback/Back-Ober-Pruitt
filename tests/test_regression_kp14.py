"""
Regression tests for KP14 model: refactored vs original code.
...
class TestKP14Regression:
    """Test suite for KP14 model regression."""

    def __init__(self):
        self.test_id = TEST_PANEL_ID
        self.panel_id = f"kp14_{self.test_id}"
        self.model = "kp14"
    ...
    def test_01_panel_generation(self):
        ...
        # Compare arrays (KP14 specific)
        array_keys = [
            'A_taylor', 'A_proj', 'f_taylor', 'f_proj'
        ]
...
def main():
    """Run all regression tests for KP14 model."""
    print("\nKP14 Model Regression Test Suite")
    print("=" * 70)

    tester = TestKP14Regression()

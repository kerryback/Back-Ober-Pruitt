"""
Regression tests for BGN model: refactored vs original code.
...
class TestBGNRegression:
    """Test suite for BGN model regression."""

    def __init__(self):
        self.test_id = TEST_PANEL_ID
        self.panel_id = f"bgn_{self.test_id}"
        self.model = "bgn"
    ...
    def test_01_panel_generation(self):
        ...
        # Compare arrays
        array_keys = [
            'A_1_taylor', 'A_2_taylor', 'A_1_proj', 'A_2_proj',
...
def main():
    """Run all regression tests for BGN model."""
    print("\nBGN Model Regression Test Suite")
    print("=" * 70)

    tester = TestBGNRegression()
